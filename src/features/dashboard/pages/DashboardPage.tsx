...
export const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        setError(
          "No se pudieron cargar los indicadores en tiempo real."
        );
  ...
  return (
    ...
    <div className="p-8 space-y-10 font-body">
      ...
      {/* NUEVO PANEL DE ALERTAS SEPARADAS */}
      ...
      <div className="space-y-8">
        ...
        {/* Panel reservado para futuras actividades */}
        ...
        >
          ...
          <p className="text-[14px] font-medium">
            Panel de actividades del sistema disponible en la siguiente fase
          </p>
